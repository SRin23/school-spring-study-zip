...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------------");
		System.out.println("TestBean2(AutoWire=byType)\n");
		TestBean2 obj2 = ctx.getBean("t2", TestBean2.class);
		System.out.println(obj2.getData3());
		System.out.println(obj2.getData4());
		
		System.out.println("------------------------------------------");
		System.out.println("TestBean3(AutoWire=constructor)\n");
		TestBean3 obj3 = ctx.getBean("t3", TestBean3.class);
		System.out.println(obj3.getData5());
		System.out.println(obj3.getData6());
		System.out.println(obj3.getData7());
